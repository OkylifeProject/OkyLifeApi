...
<div id="list-eatActivity" class="content scaffold-list" role="main">
	...
	<table>
		...
		<tr>
			...
			<g:sortableColumn property="totalCarbohydrates"
							  title="${message(code: 'eatActivity.totalCarbohydrates.label', default: 'Total Carbohydrates')}"/>
		...
		<g:each in="${eatActivityInstanceList}" status="i" var="eatActivityInstance">
			<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
				...
				<td>${fieldValue(bean: eatActivityInstance, field: "totalCarbohydrates")}</td>
