...
<div id="show-eatActivity" class="content scaffold-show" role="main">
    ...
    <ol class="property-list eatActivity">
        ...
        <g:if test="${eatActivityInstance?.okiBar}">
            <li class="fieldcontain">
                <span id="okiBar-label" class="property-label"><g:message code="eatActivity.okiBar.label"
                                                                          default="Oki Bar"/></span>

                <span class="property-value" aria-labelledby="okiBar-label"><g:link controller="okiBar" action="show"
                                                                                    id="${eatActivityInstance?.okiBar?.id}">${eatActivityInstance?.okiBar?.encodeAsHTML()}</g:link></span>
        ...
        <g:if test="${eatActivityInstance?.ingredients}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="ingredients-label"><g:fieldValue
                        bean="${eatActivityInstance}" field="ingredients"/></span>
