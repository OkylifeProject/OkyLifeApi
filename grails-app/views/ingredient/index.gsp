...
<div id="list-ingredient" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="brand" title="${message(code: 'ingredient.brand.label', default: 'Brand')}"/>

            <g:sortableColumn property="description"
                              title="${message(code: 'ingredient.description.label', default: 'Description')}"/>
        ...
        <g:each in="${ingredientInstanceList}" status="i" var="ingredientInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td>${fieldValue(bean: ingredientInstance, field: "brand")}</td>
