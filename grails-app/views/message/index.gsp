...
<div id="list-message" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <th><g:message code="message.remitent.label" default="Remitent"/></th>
        ...
        <g:each in="${messageInstanceList}" status="i" var="messageInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${messageInstance.id}">${fieldValue(bean: messageInstance, field: "subject")}</g:link></td>

                <td>${fieldValue(bean: messageInstance, field: "content")}</td>

                <td>${fieldValue(bean: messageInstance, field: "remitent")}</td>

                <td>${fieldValue(bean: messageInstance, field: "recipient")}</td>
