...
<div id="show-okiBar" class="content scaffold-show" role="main">
    ...
    <ol class="property-list okiBar">
        ...
        <g:if test="${okiBarInstance?.asociatedActivity}">
            <li class="fieldcontain">
                <span id="asociatedActivity-label" class="property-label"><g:message
                        code="okiBar.asociatedActivity.label" default="Asociated Activity"/></span>

                <span class="property-value" aria-labelledby="asociatedActivity-label"><g:link controller="activity"
                                                                                               action="show"
                                                                                               id="${okiBarInstance?.asociatedActivity?.id}">${okiBarInstance?.asociatedActivity?.encodeAsHTML()}</g:link></span>
