...
<div id="show-sportActivity" class="content scaffold-show" role="main">
    ...
    <ol class="property-list sportActivity">
        ...
        <g:if test="${sportActivityInstance?.okiBar}">
            <li class="fieldcontain">
                <span id="okiBar-label" class="property-label"><g:message code="sportActivity.okiBar.label"
                                                                          default="Oki Bar"/></span>

                <span class="property-value" aria-labelledby="okiBar-label"><g:link controller="okiBar" action="show"
                                                                                    id="${sportActivityInstance?.okiBar?.id}">${sportActivityInstance?.okiBar?.encodeAsHTML()}</g:link></span>
